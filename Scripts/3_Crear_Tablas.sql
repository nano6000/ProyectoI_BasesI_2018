...
comment on column arbol.peligroextincion is 'Marca si est� o no en peligro de extincion';
...
comment on column cambioclave.codigo is 'Identificador �nico del cambio de clave';
...
comment on column canton.codigo is 'Identificador �nico del canton';
...
comment on column clase.codigoclase is 'Identificador �nico de la clase de un orden';
...
comment on column colaborador.codigocolaborador is 'Identificador �nico de un colaborador';
comment on column colaborador.activo is 'Marca si el colaborador est� activo o no';
...
comment on column distrito.codigo is 'Identificador �nico del distrito';
...
comment on column division.codigodivision is 'Identificador �nico de la division';
...
comment on column huertaA.activo is 'Marca si una huerta est� o no aciva';
...
comment on column pais.codigo is 'Identificador �nico del pais';
...
comment on column persona.cedula is 'Identificador �nico de una persona';
...
comment on column planta.codigoplanta is 'Identificador �nico de una planta';
...
comment on column propiedad.codigopropiedad is 'Identificador �nico de una propiedad';
...
comment on column propiedadhortaliza.codigopropiedad is 'Llave foranea que relaciona una propiedad con una planta,
                                                         adem�s identificador �nico de una propiedad';
...
comment on column provincia.codigo is 'Identificador �nico de la provincia';
comment on column provincia.nombre is 'El nombre de la provincia';
comment on column provincia.pais is 'Llave foranea que relaciona la provincia con un pa�s';
...
comment on column tipocambium.codigocambium is 'Identificador �nico de un tipo de cambium';
...
comment on column tipocorteza.codigocorteza is 'Identificador �nico de un tipo de corteza';
...
comment on column tipohortaliza.codigotipo is 'Identificador �nico de un tipo de hortaliza';
...
comment on column plantatrueque.codigotransaccion is 'Llave foranea que relaciona a la entidad con una transaccion. Ademas es
                                                     identificador �nico de plantatrueque';
...
comment on column tipousuario.codigo is 'Identificador �nico de un tipo de usuario';
...
comment on column tipoxilema.codigoxilema is 'Identificador �nico de un tipo de xilema';
...
comment on column transaccion.codigotransaccion is 'Identificador �nico de una transaccion';
...
comment on column usuario.username is 'Identificador �nico del usuario';
comment on column usuario.password is 'Contrase�a actual del usuario';
...
comment on column vitamina.codigovitamina is 'Identificador �nico de una vitamina';
...
comment on column vitaminacolor.codigovitamina is 'Llave foranea que relaciona una vitamina con un color, ademas es
                                              identificador �nico de una vitamina';
