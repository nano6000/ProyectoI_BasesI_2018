...
comment on column tipotransaccion.codigotipo is 'Identificador único de un tipo de transaccion';
comment on column tipotransaccion.nombre is 'Nombre de un tipo de transaccion';
comment on column tipotransaccion.fec_creacion is 'Fecha original de la creacion de un tipo de transaccion';
comment on column tipotransaccion.usuario_creacion is 'Usuario original que lo creo';
comment on column tipotransaccion.fec_ultima_modificacion is 'Fecha de la ultima modificacion de un tipo de transaccion';
comment on column tipotransaccion.usuario_ultima_modificacion is 'Usuario que lo modifico por ultima vez';

comment on table tipotransaccion is 'Los tipos de transacciones que puede haber';
...
comment on column transaccion.tipotransaccion is 'Llave foranea que relaciona una transaccion con un tipo';
...
ALTER TABLE vitaminacolor ADD CONSTRAINT un_vitaminacolor UNIQUE ( codigovitamina, codigocolor );
